...
> **概要**: 从 GitHub 挖掘芯片设计/EDA/验证领域的可复用开源资源库，按功能分类整理，评估成熟度与适用场景，提出 Skill 化封装方案
>
> **关键词**: (待补充)
...
- [1. 开源 EDA 生态全景速览](#1-开源-eda-生态全景速览)
  - [1.1 开源 RTL-to-GDS 工具链全景](#11-开源-rtl-to-gds-工具链全景)
  - [1.2 关键资源星际图](#12-关键资源星际图)
  - [1.3 工具链覆盖矩阵](#13-工具链覆盖矩阵)
- [2. RTL 设计与 HDL 语言层](#2-rtl-设计与-hdl-语言层)
  - [2.1 Chisel — 现代硬件构建语言](#21-chisel-现代硬件构建语言)
  - [2.2 Verilator — 高性能 Verilog 仿真器](#22-verilator-高性能-verilog-仿真器)
- [3. 逻辑综合](#3-逻辑综合)
  - [3.1 Yosys — 开源综合套件](#31-yosys-开源综合套件)
- [4. 功能验证](#4-功能验证)
  - [4.1 cocotb — 基于 Python 的协同仿真框架](#41-cocotb-基于-python-的协同仿真框架)
  - [4.2 SVUT — SystemVerilog 单元测试框架](#42-svut-systemverilog-单元测试框架)
  - [4.3 SymbiYosys — 形式验证框架](#43-symbiyosys-形式验证框架)
  - [4.4 VeriFlow-CC — Claude Code 驱动的 RTL 设计管线](#44-veriflow-cc-claude-code-驱动的-rtl-设计管线)
- [5. 物理设计与后端流程](#5-物理设计与后端流程)
  - [5.1 OpenROAD/OpenLane2 — 开源 RTL-to-GDS 流程](#51-openroadopenlane2-开源-rtl-to-gds-流程)
  - [5.2 KLayout — 版图查看与验证](#52-klayout-版图查看与验证)
- [6. PDK 与工艺库](#6-pdk-与工艺库)
  - [6.1 SkyWater PDK (sky130)](#61-skywater-pdk-sky130)
  - [6.2 GlobalFoundries GF180MCU PDK](#62-globalfoundries-gf180mcu-pdk)
- [7. 芯片设计自动化与 ML for EDA](#7-芯片设计自动化与-ml-for-eda)
  - [7.1 Edalize — EDA 工具抽象层](#71-edalize-eda-工具抽象层)
  - [7.2 Veriflow-CC (LLM驱动的RTL设计)](#72-veriflow-cc-llm驱动的rtl设计)
  - [7.3 LangChain-VLSI Flow](#73-langchain-vlsi-flow)
- [8. RISC-V 核与 SoC 参考设计](#8-risc-v-核与-soc-参考设计)
  - [8.1 关键参考设计汇总](#81-关键参考设计汇总)
- [9. 学习路径与课程资源](#9-学习路径与课程资源)
  - [9.1 结构化学习资源](#91-结构化学习资源)
- [10. 各库成熟度评估](#10-各库成熟度评估)
- [11. Skill 封装建议](#11-skill-封装建议)
  - [🥇 优先级 P0 — 立即封装](#优先级-p0-立即封装)
    - [Skill 1: `chip-simulate-verilator` — Verilog/SystemVerilog 仿真](#skill-1-chip-simulate-verilator-verilogsystemverilog-仿真)
    - [Skill 2: `chip-synthesize-yosys` — RTL 逻辑综合](#skill-2-chip-synthesize-yosys-rtl-逻辑综合)
    - [Skill 3: `chip-pnr-openlane` — 布局布线自动化](#skill-3-chip-pnr-openlane-布局布线自动化)
  - [🥈 优先级 P1 — 优化封装](#优先级-p1-优化封装)
    - [Skill 4: `chip-verify-formal` — 形式验证](#skill-4-chip-verify-formal-形式验证)
    - [Skill 5: `chip-llm-design` — LLM 辅助 RTL 设计](#skill-5-chip-llm-design-llm-辅助-rtl-设计)
  - [🥉 优先级 P2 — 按需封装](#优先级-p2-按需封装)
    - [Skill 6: `chip-layout-view` — 版图查看与分析](#skill-6-chip-layout-view-版图查看与分析)
    - [Skill 7: `chip-wavedrom` — 波形查看](#skill-7-chip-wavedrom-波形查看)
  - [11.1 Skill 与现有工作空间技能的关系](#111-skill-与现有工作空间技能的关系)
- [12. 参考文献](#12-参考文献)
- [参考文件](#参考文件)
- [Changelog](#changelog)
...
- [🏭 芯片全生命周期与基础科学体系](2026-07-01-chip-full-lifecycle-overview.md) — 10 阶段通用流程
- [📏 芯片研发全流程指标参数与业界基准](02_rd/00_shared/04_quality/2026-07-01-chip-rd-metrics-industry-benchmark.md) — 15 阶段指标矩阵
- [🔬 芯片测试全栈深度分析](../test/2026-07-01-chip-test-full-stack-deep-analysis.md) — 测试体系
- [🤖 ML for EDA 深度分析](2026-07-01-chip-ml-for-eda-deep-analysis.md) — GNN/RL/BO 应用全景
...
| 日期 | 版本 | 变更说明 |
|:----|:----|:-----|
| 2026-07-01 | v1.0 | 首次创建 — 基于 GitHub API 采集的芯片设计开源生态全景，20+ 仓库评估与 7 个 Skill 封装建议 (v1.0) |
