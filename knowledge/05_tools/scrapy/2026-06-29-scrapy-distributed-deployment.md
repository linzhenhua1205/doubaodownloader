...
> **概要**: Scrapy分布式部署完整指南，基于Scrapy-Redis实现多节点协同爬取
>
> **关键词**: Scrapy · 分布式部署 · Scrapy-Redis · 断点续爬 · Docker
...
- [一、前置环境准备](#一前置环境准备)
  - [1. 统一依赖安装](#1-统一依赖安装)
  - [2. 部署 Redis 服务（核心中枢）](#2-部署-redis-服务核心中枢)
- [二、改造 Scrapy 项目（关键步骤）](#二改造-scrapy-项目关键步骤)
  - [1. 修改爬虫文件（Spider）](#1-修改爬虫文件spider)
  - [2. 核心配置 `settings.py`](#2-核心配置-settingspy)
- [三、项目打包与部署](#三项目打包与部署)
  - [1. 项目统一分发](#1-项目统一分发)
  - [2. 节点分类](#2-节点分类)
- [四、启动分布式爬虫](#四启动分布式爬虫)
  - [Step 1：向 Redis 推送起始 URL](#step-1向-redis-推送起始-url)
  - [Step 2：所有节点启动爬虫](#step-2所有节点启动爬虫)
  - [生产环境后台运行](#生产环境后台运行)
- [五、运维与监控](#五运维与监控)
  - [查看队列状态](#查看队列状态)
  - [断点续爬](#断点续爬)
...
- [爬虫框架对比与选型](2026-06-29-scrapy-crawler-comparison.md)
...
- [爬虫框架对比与选型](2026-06-29-scrapy-crawler-comparison.md) — 关联
