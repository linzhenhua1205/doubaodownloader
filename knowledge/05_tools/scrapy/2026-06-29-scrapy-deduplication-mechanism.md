...
> **概要**: Scrapy去重机制深度解析，涵盖指纹计算、RFPDupeFilter与分布式去重
>
> **关键词**: Scrapy · 去重机制 · 指纹 · RFPDupeFilter · 分布式去重
...
- [二、去重判断流程](#二去重判断流程)
  - [入队时刻](#入队时刻)
  - [完整流程](#完整流程)
- [三、指纹怎么算？（决定"什么算重复"）](#三指纹怎么算决定什么算重复)
- [四、边界情况分析](#四边界情况分析)
  - [强制跳过去重](#强制跳过去重)
- [五、分布式场景下的去重](#五分布式场景下的去重)
- [六、自定义去重器（进阶）](#六自定义去重器进阶)
- [七、一句话总结](#七一句话总结)
- [相关页面](#相关页面)
- [参考文件](#参考文件)
- [Changelog](#changelog)
