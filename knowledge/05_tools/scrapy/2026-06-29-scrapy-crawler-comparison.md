...
> **概要**: 爬虫框架全景对比与选型指南，含Scrapy、BeautifulSoup等五步决策流程
>
> **关键词**: 爬虫框架 · Scrapy · BeautifulSoup · 选型指南 · 动态爬虫

---

## 📑 目录

- [一、核心框架/方案总览](#一核心框架方案总览)
  - [① Python 静态爬虫（无 JS 渲染）](#①-python-静态爬虫无-js-渲染)
  - [② Python 动态爬虫（JS 渲染/SPA）](#②-python-动态爬虫js-渲染spa)
  - [③ 一站式/低代码框架](#③-一站式低代码框架)
  - [④ 其他语言](#④-其他语言)
- [二、Scrapy 与 BeautifulSoup 核心区别](#二scrapy-与-beautifulsoup-核心区别)
  - [定位差异](#定位差异)
  - [混用方式](#混用方式)
  - [选型原则](#选型原则)
- [三、标准选型流程（五步决策）](#三标准选型流程五步决策)
  - [Step 1：判断页面类型](#step-1判断页面类型)
  - [Step 2：评估爬取规模与周期](#step-2评估爬取规模与周期)
  - [Step 3：核对功能诉求](#step-3核对功能诉求)
  - [Step 4：资源约束](#step-4资源约束)
  - [Step 5：反爬强度](#step-5反爬强度)
- [四、分场景精准匹配表](#四分场景精准匹配表)
  - [静态页面场景](#静态页面场景)
  - [动态 JS/SPA 页面场景](#动态-jsspa-页面场景)
- [五、选型避坑指南](#五选型避坑指南)
  - [速选口诀](#速选口诀)
- [相关页面](#相关页面)
- [参考文件](#参考文件)
...
- [Scrapy 框架概述](2026-06-29-scrapy-framework-overview.md)
- [Scrapy 分布式部署](2026-06-29-scrapy-distributed-deployment.md)
- [Scrapy 去重机制](2026-06-29-scrapy-deduplication-mechanism.md)
- [Scrapy 进阶与实战](2026-06-29-scrapy-advanced-practice.md)
...
- [Scrapy 框架概述](2026-06-29-scrapy-framework-overview.md) — 关联
- [Scrapy 分布式部署](2026-06-29-scrapy-distributed-deployment.md) — 关联
- [Scrapy 去重机制](2026-06-29-scrapy-deduplication-mechanism.md) — 关联
- [Scrapy 进阶与实战](2026-06-29-scrapy-advanced-practice.md) — 关联
