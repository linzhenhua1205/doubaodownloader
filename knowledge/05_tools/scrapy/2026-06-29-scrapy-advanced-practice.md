...
> **概要**: Scrapy进阶实战，涵盖Playwright集成、反爬对抗、监控部署与最佳实践
>
> **关键词**: Scrapy · Playwright · 反爬 · Scrapyd · 数据持久化

---

## 📑 目录

- [一、Scrapy + Playwright（JS 渲染）](#一scrapy-playwrightjs-渲染)
  - [安装](#安装)
  - [配置](#配置)
  - [使用](#使用)
  - [适用判断](#适用判断)
- [二、反爬对抗策略](#二反爬对抗策略)
  - [常见反爬手段与应对](#常见反爬手段与应对)
  - [代理池集成](#代理池集成)
- [三、数据持久化 Pipeline](#三数据持久化-pipeline)
- [四、爬虫监控与部署](#四爬虫监控与部署)
  - [监控指标](#监控指标)
  - [Scrapyd 远程部署](#scrapyd-远程部署)
  - [Docker 化部署](#docker-化部署)
- [五、大规模爬虫最佳实践](#五大规模爬虫最佳实践)
- [六、典型常见错误](#六典型常见错误)
- [相关页面](#相关页面)
- [参考文件](#参考文件)
- [Changelog](#changelog)
...
- [Scrapy 框架概述](2026-06-29-scrapy-framework-overview.md) — 基础概念、核心组件、快速入门
- [爬虫选型对比](../methodology-tools/2026-06-28-programming-tools.md) — Scrapy vs BS vs Playwright 全景
...
- [爬虫选型对比](../methodology-tools/2026-06-28-programming-tools.md) — 关联
