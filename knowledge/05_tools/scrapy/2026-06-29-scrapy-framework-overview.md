...
> **概要**: Scrapy爬虫框架概述，详解七大核心组件、运行流程与快速入门
>
> **关键词**: Scrapy · 爬虫框架 · 异步引擎 · Item Pipeline · 中间件
...
- [定位：完整爬虫框架](#定位完整爬虫框架)
  - [与 BeautifulSoup 对比](#与-beautifulsoup-对比)
- [七大核心组件](#七大核心组件)
  - [运行流程](#运行流程)
- [快速入门：一个完整爬虫](#快速入门一个完整爬虫)
- [Item Pipeline 典型用法](#item-pipeline-典型用法)
- [下载中间件场景](#下载中间件场景)
- [选型建议](#选型建议)
- [与 BeautifulSoup 混用](#与-beautifulsoup-混用)
- [常见陷阱](#常见陷阱)
- [核心配置速查](#核心配置速查)
- [相关页面](#相关页面)
- [参考文件](#参考文件)
...
- [Scrapy 进阶与实战](2026-06-29-scrapy-advanced-practice.md) — 分布式、反爬、JS渲染、监控
- [编程工具对比选型](../methodology-tools/2026-06-28-programming-tools.md) — Scrapy vs BS vs Playwright 全景对比
...
- [编程工具对比选型](../methodology-tools/2026-06-28-programming-tools.md) — 关联
