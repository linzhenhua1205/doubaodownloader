...
> **概要**: LinkedIn爬虫完整实现架构，涵盖反检测、会话管理与数据分析管道
>
> **关键词**: LinkedIn爬虫 · 反检测 · Playwright · 代理池 · 数据管道
...
- [1. 整体架构图](#1-整体架构图)
- [2. 反检测基础设施层](#2-反检测基础设施层)
  - [核心问题](#核心问题)
  - [2.1 指纹模拟器](#21-指纹模拟器)
  - [2.2 代理池管理](#22-代理池管理)
  - [2.3 速率限制器](#23-速率限制器)
  - [2.4 Cookie 与 Session 管理](#24-cookie-与-session-管理)
- [3. 浏览器会话管理层](#3-浏览器会话管理层)
  - [3.1 Playwright + Stealth 引擎](#31-playwright-stealth-引擎)
  - [3.2 登录与账号管理](#32-登录与账号管理)
- [4. 人才发现引擎](#4-人才发现引擎)
  - [4.1 路径 A: LinkedIn 搜索（核心路径）](#41-路径-a-linkedin-搜索核心路径)
  - [4.2 路径 B: Google Dork](#42-路径-b-google-dork)
  - [4.3 路径 C: Voyager (GraphQL) API](#43-路径-c-voyager-graphql-api)
  - [4.4 路径汇总与调度](#44-路径汇总与调度)
- [5. 个人资料抽取器](#5-个人资料抽取器)
  - [5.1 DOM 解析 + 工作经历提取](#51-dom-解析-工作经历提取)
  - [5.2 工作经历解析器](#52-工作经历解析器)
  - [5.3 技能过滤引擎](#53-技能过滤引擎)
- [6. 数据分析管道](#6-数据分析管道)
  - [6.1 完整 Pipeline](#61-完整-pipeline)
  - [6.2 可视化输出](#62-可视化输出)
- [7. 部署与运维](#7-部署与运维)
  - [7.1 完整启动脚本](#71-完整启动脚本)
  - [7.2 Docker 部署](#72-docker-部署)
- [延伸阅读](#延伸阅读)
  - [反检测技术演进方向](#反检测技术演进方向)
  - [LinkedIn 反爬等级对照](#linkedin-反爬等级对照)
  - [与 Anthropic 分析的数据规模对比](#与-anthropic-分析的数据规模对比)
- [参考文件](#参考文件)
- [Changelog](#changelog)
...
- 来源: Milan Griffes（招聘方向）的公开分析 + 工程化实现推导
