...
> **概要**: 编译构建工具演进全分析，从手工编译、Make、CMake到Bazel的代际演进与设计哲学
>
> **关键词**: 构建系统 · Make · CMake · Bazel · 依赖图DAG
...
- [3. 第一代构建工具：Make](#3-第一代构建工具make)
  ...
  - [3.4 Make的优缺点](#34-make的优缺点)
    - [✅ 优点](#优点)
    - [❌ 缺点](#缺点)
    - [💡 Make的"隐式依赖缺失"问题详解](#make的隐式依赖缺失问题详解)
...
- [8. 第四代构建系统：Bazel与Hermetic构建](#8-第四代构建系统bazel与hermetic构建)
  ...
  - [8.3 Bazel的核心机制](#83-bazel的核心机制)
    - [1. 内容寻址(Content-Addressable)](#1-内容寻址content-addressable)
    - [2. STarlark构建语言](#2-starlark构建语言)
    - [3. 远程缓存与执行](#3-远程缓存与执行)
    - [4. 构建图 + 动作图](#4-构建图-动作图)
...
- [CLI三次演进](05_tools/ai-tools/2026-06-23-cli-evolution-three-generations.md) — 命令行工具代际范式与本报告"演化驱动力"的分析方法互补
- [版本方法与兼容性方案全景分析](02_rd/01_product/01_software/2026-06-29-versioning-and-compatibility-methodology.md) — 语义化版本(SemVer)与Cargo依赖解析相关
- [工程活动全景指南](02_rd/03_management/01_product-management/2026-06-22-engineering-activities-compass.md) — 构建活动在工程全景中的定位
