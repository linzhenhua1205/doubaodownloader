...
**Expected output**: a prioritized competitor brief plus the standard handoff summary for `knowledge/07_industry-research/competitor/`.
...
- **Promotes**: durable competitor facts, keyword priorities, entity candidates, and pending strategy decisions to `knowledge/07_industry-research/competitor/hot-cache.md`, and `knowledge/07_industry-research/competitor/open-loops.md`.
...
After delivering, offer to save `knowledge/07_industry-research/competitor/YYYY-MM-DD-<topic>.md` and promote durable conclusions to `knowledge/07_industry-research/competitor/hot-cache.md`.
