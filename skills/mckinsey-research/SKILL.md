...
description: |
  ...
  OUTPUT: Complete strategy report saved to knowledge/07_industry-research/mckinsey/{date}-{slug}.html
...
1. Read all analysis outputs from `knowledge/07_industry-research/mckinsey/{slug}/`
...
4. Save to `knowledge/07_industry-research/mckinsey/{date}-{slug}.html`
...
- Individual analyses: `knowledge/07_industry-research/mckinsey/{slug}/{analysis-name}.md`
- Final report: `knowledge/07_industry-research/mckinsey/{date}-{slug}.html`
- Raw data: `knowledge/07_industry-research/mckinsey/{slug}/data/`
