...
| file write | Yes | Only to the single output path: `knowledge/07_industry-research/mckinsey/{slug}/{analysis-name}.md` |
| exec | No | |
| message | No | |
| browser/camofox | No | |
...
- Each research run writes to a unique directory: `knowledge/07_industry-research/mckinsey/{slug}/`
