...
2. **`product-marketing`** — Sets up the foundational `skills/marketing/product-marketing/SKILL.md` context file (positioning, ICP, voice). Read this first; Section 2 (Strategic frame) builds on it.
...
- **`product-marketing`** — Run first. Captures positioning, ICP, voice in `skills/marketing/product-marketing/SKILL.md` so every section of the plan references the same foundation.
