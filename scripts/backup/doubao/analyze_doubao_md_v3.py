...
OUTPUT_DIR = "h:/github/md/analysis_results_v3"
...
def categorize_content(title, body):
    ...
    categories = {
        '服务器研发': [
            '服务器', 'bmc', '固件', '硬件', '研发', '设计', '架构',
            'cpu', 'gpu', '内存', '存储', 'pcie', 'nvme', 'ssd',
            '主板', '芯片', '板卡', '机箱', '电源', '散热', '液冷',
            'bios', 'uefi', '固件开发', '硬件开发', '服务器研发',
            '刀箱', '节点', '集群', '算力', '智算', '数据中心'
        ],
        '编程开发': [
        ...
        '人工智能': [
            ...
            '豆包', 'chatgpt', 'llm', '自然语言', 'nlp', '计算机视觉',
            '强化学习', '模型训练', '推理', '微调', 'prompt', '智能体',
            'agent', 'rag', 'embedding', '向量数据库', '生成式'
        ],
        '系统运维': [
            '运维', '部署', '配置', '监控', '日志', '性能', '优化',
            '网络', '安全', '服务器管理', '自动化', '脚本',
            '监控系统', '告警', '故障排查', '灾备', '备份', '恢复'
        ],
        '人文社科': [
            '哲学', '历史', '社会', '文化', '伦理', '道德', '政治',
            '经济', '心理', '教育', '文学', '艺术', '思想',
            '价值', '意义', '人性', '社会变革', '文明', '文化传承'
        ],
        '商业管理': [
