...
def update_latest_updates():
    print("=" * 80)
    print("更新S级文章的2025-2026最新进展")
    print("=" * 80)

    updated_count = 0

    for category, updates_text in CATEGORY_LATEST_UPDATES.items():
        ...
        for md_file in cat_dir.glob("*.md"):
            ...
            try:
                ...
                if "## 🆕 2025-2026 最新进展" not in content:
                    continue

                old_pattern = r"## 🆕 2025-2026 最新进展\n\n.*?\n(?=## )"
